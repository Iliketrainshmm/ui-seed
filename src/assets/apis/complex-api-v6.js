module.exports = {
  ...
  info: {
    title: "Complex API 1",
    description:
      "API resources related to the retail industry. You may download the swagger.json definition to use in your API Management demos. Optionally, you can obtain the [source code](https://hub.jazz.net/git/bakert/apim-smart) and run it locally.",
    version: "1.0.0",
    "x-ibm-name": "Complex-api-1",
  },
  basePath: "/smart/v1",
  schemes: ["https"],
